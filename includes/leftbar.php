<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="images/2h.gif" alt="Tito" class="img-circle profile-img">
                                <h6 class="title"></h6>
                                <small class="info">Member</small>
                            </div>
                            <!-- /.user-info -->
   ...
   <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            ...
                                            <li><a href="manage-students.php"><i class="fa fa fa-server"></i> <span>manage Students</span></a></li>
                                             <li><a href="delete-student.php"><i class="fa fa fa-server"></i> <span>Delete Students</span></a></li>
...
<li class="has-children">
           ...
           <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="add-result.php"><i class="fa fa-bars"></i> <span>Add Rttendance</span></a></li>
                                            <li><a href="manage-results.php"><i class="fa fa fa-server"></i> <span>Manage Attendance</span></a></li>
