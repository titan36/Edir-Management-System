                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>የዕድር አባላት</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                      ...
                                      <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>የዕድር አስተዳዳሪዎች</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-admin.php"><i class="fa fa-bars"></i> <span>የዕድር አስተዳዳሪዎች ይመዝግቡ</span></a></li>
                          ...
                          <a href="manage-assets.php"><i class="fa fa-newspaper-o"></i> <span>የዕድሩን ሃብት ያስተዳድሩ</span></a></li>
                                    ...
                                    <li class="has-children">
                                      ...
                                      <li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>ምርጫ</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-candidate.php"><i class="fa fa-bars"></i> <span>ተመራጭ ይምዝግቡ</span></a></li>
                                            <li><a href="manage-candidate.php"><i class="fa fa fa-server"></i> <span>ተመራጭ ያስተዳድሩ</span></a></li>
                                        </ul>
                                        <li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>ሚና</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-role.php"><i class="fa fa-bars"></i> <span>ሚና ይመዝግቡ</span></a></li>
                                            <li><a href="manage-role.php"><i class="fa fa fa-server"></i> <span>ሚና ያስተዳድሩ</span></a></li>
                                     
                                           
                                        </ul>
                                    <li class="has-children">
                                         <a href="#"><i class="fa fa-info-circle"></i> <span>አቴንዳንስ</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
