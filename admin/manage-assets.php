                    ...
                    <td><?php echo htmlentities($cnt);?></td>
                        ...
                        <td><?php if($result->status==1){ echo htmlentities('Active'); }
                                      ...
                                      echo htmlentities('Inactive'); 
                                                                ...
                                                                ?></td>
                        <td>
                            <a href="edit-assets.php?user_id=<?php echo htmlentities($result->id);?>" class="btn btn-warning">Edit </a>
                            <a href="manage-assets.php?delete=<?php echo htmlentities($result->id);?>" data-toggle="modal"  class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
                            <?php $cnt=$cnt+1;}} ?>                                                    
                                </tbody>
