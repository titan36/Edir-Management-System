                    ...
                    <tr>
                        ...
                        <td><?php if($result->is_active==1){ echo htmlentities('Active'); }
                                      ...
                                      echo htmlentities('Inactive'); 
                                                                ...
                                                                ?></td>
                        <td>
                            <a href="edit-admin.php?user_id=<?php echo htmlentities($result->id);?>" class="btn btn-warning"><i class="fa fa-edit" title="Edit Record"></i>Edit </a>
                            <a href="delete_admin.php?id=<?php echo htmlentities($result->id);?>" data-toggle="modal"  class="btn btn-danger">Delete</a>
                        </td>
                        </tr>
                            <?php $cnt=$cnt+1;}} ?>                                                    
                                </tbody>
